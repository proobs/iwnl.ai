...
export const Navbar = (loggedIn = false, homepage = true) => {
  return (
    <nav className="py-4">
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        {loggedIn && (
          <a href="/signout"className="inline-flex items-center justify-center rounded-full px-6 py-2 bg-blue-500 hover:bg-blue-600 text-white  text-primary-foreground hover:bg-primary/400">
            Sign Out →
          </a>
        )}
